...
function NeuralCanvas({ style, density = 52 }) {
  ...
  useEffect(() => {
    ...
    const effectiveDensity = Math.max(
      26,
      Math.min(density, window.innerWidth < 520 ? 34 : density)
    );
    ...
    const nodes = Array.from({ length: effectiveDensity }, () => ({
      ...
      hue: Math.random() < 0.6 ? "indigo" : "cyan",
    }));
    ...
    function draw() {
      ...
      for (let i = 0; i < nodes.length; i++)
        for (let j = i + 1; j < nodes.length; j++) {
          ...
          if (d < 140) {
            const a = 0.10 * (1 - d / 140);
            ctx.beginPath();
            ctx.moveTo(nodes[i].x, nodes[i].y);
            ctx.lineTo(nodes[j].x, nodes[j].y);
            ctx.strokeStyle =
              nodes[i].hue === "cyan" || nodes[j].hue === "cyan"
                ? `rgba(34,211,238,${a})`
                : `rgba(79,70,229,${a})`;
            ctx.lineWidth = 0.6;
            ctx.stroke();
...
const PIPELINE_STEPS = [
  {
    label: "Canonicalise",
    desc: "Authoritative frameworks are normalised into canonical capability units with traceability to source and version history.",
  },
  {
    label: "Version",
    desc: "Capability objects are maintained like software — consistent schema, diffs, and change control designed for reuse.",
  },
  {
    label: "Verify",
    desc: "Evidence rails aligned to real-world performance: observation, simulation, third-party evidence, and review gates.",
  },
  {
    label: "Enforce",
    desc: "Delivered via APIs, dashboards, or secure/on-prem deployment — designed to integrate into modern stacks and workflows.",
  },
];

const MARKETS = [
  {
    label: "Enterprise Workforce Assurance",
    tag: "ASSURANCE",
    desc: "Reduce audit risk and capability drift with verifiable skill objects and evidence workflows — so capability is proven, not assumed.",
  },
  {
    label: "Education Platforms / Content Ops",
    tag: "CONTENT OPS",
    desc: "Structured capability components that hold integrity across delivery channels — versioned, maintainable, and ready for scale.",
  },
  {
    label: "Government / High-Assurance",
    tag: "HIGH-ASSURANCE",
    desc: "Defensible frameworks and evidence trails for high-accountability environments — built to withstand scrutiny and change over time.",
  },
];
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow:
          "0 10px 26px rgba(0,0,0,0.35), 0 0 0 1px rgba(255,255,255,0.12) inset",
      }}
    >
      {children}
    </button>
...
function MediaPlaceholder({ label = "IMAGE / VISUAL PLACEHOLDER", hint }) {
  return (
    <div
      className="uccaHeroVisual"
      style={{
        borderRadius: 18,
        border: `1px solid ${COLORS.border}`,
        background:
          "linear-gradient(135deg, rgba(79,70,229,0.20) 0%, rgba(34,211,238,0.10) 40%, rgba(255,255,255,0.03) 100%)",
        padding: 18,
        minHeight: 220,
        position: "relative",
        overflow: "hidden",
    ...
    >
      ...
      <div style={{ position: "relative" }}>
        ...
        <div style={{ fontSize: 14, color: "rgba(255,255,255,0.75)", lineHeight: 1.6 }}>
          {hint || "Replace with premium visual."}
        </div>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.05, minWidth: 0 }}>
            ...
            <span style={{ fontSize: 11, color: COLORS.text3, whiteSpace: "nowrap" }}>
              ucca.online
            </span>
          </div>
        </div>

        <div className="uccaNavActions" style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <GhostButton className="uccaBtn" onClick={() => {}}>
            Contact
          </GhostButton>
          <GradientButton className="uccaBtn" onClick={() => {}}>
            Request Briefing
          </GradientButton>
        </div>
      </nav>
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(90deg, rgba(7,10,18,0.92) 0%, rgba(7,10,18,0.75) 40%, rgba(7,10,18,0.30) 100%)",
          }}
        />
        <div
          className="uccaHeroGrid"
          style={{
            position: "relative",
            zIndex: 2,
            width: "100%",
        ...
        >
          <div>
            ...
            <h1
              style={{
                ...
                transition: "all 0.95s ease 0.25s",
              }}
            >
              Human capability
              <br />
            ...
            >
              ...
              reliably do. We convert standards, tasks, and proof requirements into <b>versioned capability objects</b>{" "}
              that can be enforced in workflows, verified with evidence, and delivered via APIs.
            </p>

            <div
              className="uccaHeroCtas"
              style={{
                display: "flex",
                gap: 12,
                alignItems: "center",
          ...
          >
            <MediaPlaceholder
              label="HERO VISUAL"
              hint="Suggested: premium abstract capability topology / skill-graph render."
            />
            <div className="uccaHeroMiniGrid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 12 }}>
              <Pill>
                <div style={{ fontSize: 12, letterSpacing: 2, textTransform: "uppercase", color: COLORS.text3 }}>
                  People
                </div>
                <div style={{ fontSize: 14, marginTop: 8, color: COLORS.text2, lineHeight: 1.5 }}>
        ...
        <div style={{ maxWidth: 1040, margin: "0 auto", textAlign: "center" }}>
          ...
          <FadeIn delay={0.1}>
            ...
            >
              ...
              <span
                style={{
                  background: `linear-gradient(135deg, ${COLORS.accent3} 0%, ${COLORS.accent2} 70%)`,
                  WebkitBackgroundClip: "text",
                  backgroundClip: "text",
                  color: "transparent",
                }}
          ...
          <FadeIn delay={0.38}>
            <div className="ucca3col" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginTop: 26 }}>
              {[
                {
                  k: "Today",
                  title: "Human work",
                  text: "Define competence and prove it with evidence — consistent, auditable, repeatable.",
                },
                {
                  k: "Now",
                  title: "AI systems",
                  text: "Constrain agents with capability rules: allowed actions, evidence output, and review gates.",
                },
                {
                  k: "Next",
                  title: "Robotics",
                  text: "Use the same capability objects as training targets and certification gates for autonomous work.",
                },
              ].map((c) => (
      ...
      <section style={{ padding: "88px 40px", background: COLORS.bg2 }}>
        <div className="ucca2col" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 26 }}>
          <div>
            <FadeIn>
              <div style={{ borderLeft: `3px solid ${COLORS.accent2}`, paddingLeft: 18, marginBottom: 18 }}>
                <h2
                  style={{
                    fontSize: "clamp(30px, 3.7vw, 54px)",
                    fontWeight: 900,
                    letterSpacing: -1.2,
                    lineHeight: 1.05,
                    margin: 0,
      ...
      <section style={{ padding: "96px 40px", background: COLORS.bg }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <FadeIn style={{ textAlign: "center", marginBottom: 34 }}>
            <p style={{ fontSize: 12, letterSpacing: 3, textTransform: "uppercase", color: COLORS.text3, marginBottom: 10 }}>
              The platform
            </p>
          ...
          <div className="ucca2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
      ...
      <section style={{ padding: "96px 40px", background: COLORS.bg2 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div className="uccaMarkets" style={{ display: "grid", gridTemplateColumns: "260px 1fr", gap: 14, marginTop: 22 }}>
                  ...
                  >
                    <div
                      style={{
                        ...
                        letterSpacing: 3,
                        textTransform: "uppercase",
                        color: active ? COLORS.accent2 : COLORS.text3,
                      }}
                    >
                      {m.tag}
                    </div>
                    ...
                    <div
                      style={{
                        fontSize: 12.5,
                        color: active ? "rgba(255,255,255,0.75)" : COLORS.text3,
                        marginTop: 8,
                        lineHeight: 1.5,
                      }}
                    >
            ...
            >
              ...
              />
              <div style={{ position: "relative" }}>
                <div style={{ fontSize: 11, letterSpacing: 3, textTransform: "uppercase", color: COLORS.accent2 }}>
                  {MARKETS[activeMarket].tag}
                </div>
                <h3 style={{ fontSize: 34, fontWeight: 950, letterSpacing: -1.2, margin: "10px 0 10px" }}>
                  {MARKETS[activeMarket].label}
                </h3>
      ...
      <section style={{ padding: "112px 40px", background: COLORS.bg, textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at 50% 20%, rgba(167,139,250,0.16), transparent 60%), linear-gradient(180deg, rgba(7,10,18,0.4), rgba(7,10,18,0.9))",
          }}
        />
        <div style={{ position: "relative", zIndex: 2, maxWidth: 980, margin: "0 auto" }}>
          <FadeIn>
            <h2 style={{ fontSize: "clamp(26px, 4vw, 58px)", fontWeight: 950, letterSpacing: -1.4, lineHeight: 1.12, margin: "0 auto 16px" }}>
              ...
              <span
                style={{
                  background: `linear-gradient(135deg, ${COLORS.accent2} 0%, ${COLORS.accent3} 85%)`,
                  WebkitBackgroundClip: "text",
                  backgroundClip: "text",
                  color: "transparent",
                }}
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center", flexWrap: "wrap" }}>
          ...
          <div style={{ fontSize: 12, color: COLORS.text3, textAlign: "right" }}>
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap", justifyContent: "flex-end" }}>
              {["ucca.online", "ucca.eu", "ucca.asia"].map((d) => (
